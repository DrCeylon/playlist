...
SCENARIO_IMPLEMENTATION: dict[str, tuple[str, ...]] = {
    ...
    "sync.partial_failure": ("tests/e2e/test_integration_bridge_sync.py",),
    "sync.conflicts.resolve": ("tests/e2e/test_integration_bridge_sync.py", "tests/test_resolve_sync_bridge.py"),
    "sync.apply.idempotent": ("tests/e2e/test_integration_bridge_sync.py", "tests/test_playlist_sync_apply.py"),
    "sync.stale_plan": ("tests/e2e/test_integration_bridge_sync.py", "tests/test_playlist_sync_apply.py"),
    "sync.stale_local_version": ("tests/e2e/test_integration_bridge_sync.py", "tests/test_playlist_sync_apply.py"),
    "sync.mirror.confirmation": ("tests/e2e/test_integration_bridge_sync.py", "tests/test_playlist_sync_apply.py"),
