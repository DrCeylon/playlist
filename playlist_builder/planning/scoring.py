...
def apply_text_preferences(candidate: CandidateTrack, constraints: GenerationConstraints) -> CandidateTrack:
    """Apply deterministic inclusion/exclusion scoring.

    The current Sprint 2 engine intentionally keeps the logic explainable. The
    report can therefore tell the user *why* a track was selected or rejected.
    """
